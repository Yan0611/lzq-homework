...
import com.example.shop.adapter.LaunchImproveAdapter;

public class   LaunchImproveActivity extends AppCompatActivity {
    // 声明引导页面的图片数组
    private int[] lanuchImageArray = {R.drawable.airpodspro,
            R.drawable.huawei, R.drawable.triangle, R.drawable.sony};
